class MosScaffoldGenerator < Rails::Generator::NamedBase
  ...
  def manifest
    record do |m|
      ...
      m.template("view_items.haml", File.join('app/views', controller_class_path, controller_file_name, "_#{plural_name}.haml"))
